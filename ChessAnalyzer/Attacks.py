...
def is_attacked(sq,side,board):
    ...
    if side==WHITE:
        #pawns
        if board.pieces120[sq-11]==piece.white_pawn:
            return True,sq-11
        if board.pieces120[sq-9]==piece.white_pawn:
            return True,sq-9
    else:
        # pawns
        if board.pieces120[sq + 11] == piece.black_pawn:
            return True,sq+11
        if board.pieces120[sq + 9] == piece.black_pawn:
            return True,sq+9
